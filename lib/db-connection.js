...
async function initConnection() {
  ...
  if (!postgresUrl) {
    ...
    console.error('[DB-CONNECTION] Проверенные переменные: NEON_DATABASE_URL, library_NEON_DATABASE_URL, DATABASE_URL, library_DATABASE_URL, POSTGRES_URL, library_POSTGRES_URL, POSTGRES_PRISMA_URL, library_POSTGRES_PRISMA_URL');
